...
<button class="ref"><a href="https://br.freepik.com/vetores-gratis/indique-a-um-amigo-ilustracao-do-conceito_16807919.htm#query=denuncia&position=20&from_view=search&track=sph" target="_blank">...</a> </button>
  <div class="container">
      ...
      <div class="form">
      <form enctype="multipart/form-data" action="test_anonimo.php" method="POST" class="fomulario">
          <div class="header">
              <div class="titulo">
          ...
          <div class="grupo">
            ...
            <input type="text" class="form-control" id="Nome" name="Nome" value=""  placeholder="Ex: Rua do condor">
            </div>
            <div class="caixas">
            ...
            <label>Latitude</label>
              <input type="text" class="form-control" id="Latitude" name="Latitude" placeholder="Ex: -25.423309">
            </div>
            <div class="caixas">
            <label>Longitude</label>
              <input type="text" class="form-control" id="Longitude" name="Longitude" placeholder="Ex: -49.181568">
            </div>
          </div>
            <div class="caixas">
            ...
            <div class="bt-cad"> <button type="submit" name="enviaranonimo"> <h6>Enviar</h6> </button></div>  
          </form>  
      </div>
    </div>
</form>
